        ...
        >
            ...
            <section className="py-12 md:py-16 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
                                ...
                                <form onSubmit={handleSubmitRegistration} className="space-y-8">
                                    ...
                                    <div className="pt-4 border-t border-slate-200 space-y-4">
                                        ...
                                        <button
                                            ...
                                            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:bg-slate-300 text-white text-sm font-bold shadow-md shadow-blue-600/20 hover:shadow-lg transition-all cursor-pointer disabled:cursor-not-allowed"
                                        >
                    ...
                    {/* REQUIREMENTS CARD */}
                    <div className="bg-white border border-slate-200 rounded-3xl p-8 sm:p-10 shadow-2xs">
                        ...
                        <div className="space-y-3">
                            {requirements.map((req, idx) => (
                                <div
                                    key={idx}
                                    className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 text-xs sm:text-sm text-slate-700 flex items-start gap-2.5"
                                >
                    ...
                    <div className="bg-white border border-slate-200 rounded-3xl p-8 sm:p-10 shadow-2xs">
                        ...
                        <div className="space-y-4">
                            {schedules.map((sch, idx) => (
                                <div
                                    key={idx}
                                    className="p-4 rounded-xl bg-emerald-50/50 border border-emerald-100 text-xs sm:text-sm text-slate-700 font-medium"
                                >
                                    {sch}
                                </div>
                            ))}
                    ...
                    {/* CONTACT PANITIA */}
                    <div className="bg-blue-50/70 border border-blue-200/80 rounded-3xl p-8 text-center space-y-3">
